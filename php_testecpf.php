...
<html lang="pt-BR">
	...
	<body>
		...
		<form action="php_testecpf.php" method="POST" style="border: 0px">
			<p>CPF: <input type="text" maxlength="14" name="cpf" style="width: 100px"
				value="<?php echo htmlspecialchars( $cpf, ENT_QUOTES | ENT_SUBSTITUTE | ENT_HTML401, "ISO-8859-1"); ?>"
				oninput="formatar_mascara( this, '999.999.999-99')" autofocus></p>
